public class Main {
    public static void main(String[] args) {
        ...
        int stedingPlace = 60;  // Присвоение занятых стоящих мест
        ...
        System.out.println("\nTask 7\n");    // Седьмое задание
        int one = 1; // Присвоение числа первому значению
        int two = 5; // Присвоение числа второму значению
        int three = 3;  // Присвоение числа третьему значению
